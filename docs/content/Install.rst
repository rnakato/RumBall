...
With this command you can build the Apptainer file (.sif) of RumBall:

.. code-block:: bash

   apptainer build rumball.sif docker://rnakato/rumball

Instead, you can download the RumBall Apptainer image from our `Dropbox <https://www.dropbox.com/scl/fo/lptb68dirr9wcncy77wsv/h?rlkey=whhcaxuvxd1cz4fqoeyzy63bf&dl=0>`_ (We use Apptainer version 1.4.1).
